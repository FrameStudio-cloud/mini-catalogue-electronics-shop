...
function Hero() {
  ...
  return (
    <section id="home" className="relative min-h-screen bg-primary overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-4 pt-28 pb-16 min-h-screen flex flex-col justify-center">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          {/* Right — Service image cards */}
          <div className="relative">
            {/* Large main card — CCTV */}
            ...
            {/* Floating stats card */}
            {/* <div className="absolute -bottom-4 -left-4 bg-surface border border-white/10 rounded-xl px-4 py-3 shadow-xl hidden sm:block">
              <p className="text-accent font-extrabold text-xl" style={{ fontFamily: 'var(--font-display)' }}>500+</p>
              <p className="text-slate-400 text-xs">Installations Done</p>
            </div> */}
          </div>
        </div>
